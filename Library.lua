...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        function KeyPicker:Update()
            ...
            -- Use UIListLayout.AbsoluteContentSize to avoid GetChildren scan
            local layout = Library.KeybindContainer:FindFirstChildWhichIsA('UIListLayout')
            local YSize = layout and layout.AbsoluteContentSize.Y or 0
            local XSize = 0
            for _, Label in next, Library.KeybindContainer:GetChildren() do
                if Label:IsA('TextLabel') and Label.Visible and Label.TextBounds.X > XSize then
