...
function Library:MakeDraggable(Instance, Cutoff)
    ...
    local function _onMouseMove(Input)
    ...
    Instance.InputBegan:Connect(function(Input)
        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            offY = dy;
            Dragging = true;
            -- подключаем движение только пока тащим — ноль оверхеда в покое
            _dragConn = InputService.InputChanged:Connect(_onMouseMove);
        end;
    end);
...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        function KeyPicker:Update()
            ...
            local XSize = _keybindLayout and _keybindLayout.AbsoluteContentSize.X or 0;
